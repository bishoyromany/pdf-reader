        ...
        <>
            <div id="outerContainer">
                    ...
                    <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
                        <div id="secondaryToolbarButtonContainer">
                            <button id="secondaryOpenFile" class="secondaryToolbarButton visibleLargeView"
                                style={{ display: 'none' }} title="Open File" tabindex="51" data-l10n-id="open_file">
                                <span data-l10n-id="open_file_label">Open</span>
                            </button>

                            <button id="secondaryPrint" class="secondaryToolbarButton visibleMediumView" style={{ display: 'none' }}
                            ...
                            <button id="secondaryDownload" class="secondaryToolbarButton visibleMediumView"
                                style={{ display: 'none' }} title="Save" tabindex="53" data-l10n-id="save">
                ...
                <div id="dialogContainer">
                    ...
                    <dialog id="printServiceDialog" style={{ maxWidth: '200px' }}>
                        <div class="row">
            ...
            <div style={{ zIndex: 1000, backgroundColor: 'transparent', position: 'absolute', top: '0px', left: '0px', width: '100vw', 'height': '100vh' }}
                id="zoom"></div>
        </>
    )
}
